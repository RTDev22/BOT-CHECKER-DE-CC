        ...
        if (!message.member.permissions.has("MANAGE_MESSAGES")) {
            message.reply({ embeds: [
                new Discord.MessageEmbed()
                    .setColor("RED")
                    .setDescription(`:x: - Você não tem permissões suficientes para usar este comando!`)
            ]})
        } else {
            ...
            if (!args[0]) {
                ...
                let embed = new Discord.MessageEmbed()
                .setColor("YELLOW")
                .setDescription(`:wave: Olá ${message.author}, qual seria o formator que deseja enviar o comando?`);
